...
const CommentDetails = ({ comment, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${comment.id}/edit`} class="btn btn-secondary mr-2">Edit comment</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete comment</button>
      </div>
    </div>
  </div>;
