...
const PostDetails = ({ post, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${post.id}/edit`} class="btn btn-secondary mr-2">Edit post</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete post</button>
      </div>
    </div>
  </div>;
